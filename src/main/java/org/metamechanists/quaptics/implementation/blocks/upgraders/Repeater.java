...
public class Repeater extends ConnectedBlock {
    ...
    private final Vector3f concreteDisplaySize = new Vector3f(settings.getDisplayRadius()+0.01F, 0.08F, settings.getDisplayRadius()+0.01F);
    private final Vector3f concreteOffset = new Vector3f(0, -0.175F, 0);
