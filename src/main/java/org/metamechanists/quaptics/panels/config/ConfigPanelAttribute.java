    ...
    public ConfigPanelAttribute(final ConnectionGroupId groupId, @NotNull final String name, @NotNull final String key,
        ...
        this.displayGroupId = new DisplayGroupId(new ModelBuilder()
                .add("key", new ModelText()
                        ...
                        .size(size)
                        .location(new Vector(-0.06, 0, 0.15).rotateAroundY(rotation.y).toVector3f())
                        .rotation(rotation))
                .add("value", new ModelText()
                        .brightness(15)
                        .background(Color.fromARGB(0, 0, 0, 0))
                        .size(size)
                        .location(new Vector(0.41, 0, 0.15).rotateAroundY(rotation.y).toVector3f())
                        .rotation(rotation))
                .add("sub", new ModelText()
                        ...
                        .background(Color.fromARGB(0, 0, 0, 0))
                        .size(size)
                        .location(new Vector(0.24, 0, 0.15).rotateAroundY(rotation.y).toVector3f())
                        .rotation(rotation))
                .add("add", new ModelText()
                        ...
                        .background(Color.fromARGB(0, 0, 0, 0))
                        .size(size)
                        .location(new Vector(0.59, 0, 0.15).rotateAroundY(rotation.y).toVector3f())
                        .rotation(rotation))
