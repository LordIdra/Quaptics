    ...
    public ConfigPanelAttribute(final ConnectionGroupId groupId, @NotNull final String name, @NotNull final String key,
        ...
        this.displayGroupId = new DisplayGroupId(new ModelBuilder()
                ...
                .add("value", new ModelText()
                        ...
                        .background(Color.fromARGB(0, 0, 0, 0))
                        .size(size)
                        .location(new Vector(0.40, 0, 0.15).rotateAroundY(rotation.y).toVector3f())
                        .rotation(rotation))
                .add("sub", new ModelText()
                        ...
                        .background(Color.fromARGB(0, 0, 0, 0))
                        .size(size)
                        .location(new Vector(0.25, 0, 0.15).rotateAroundY(rotation.y).toVector3f())
                        .rotation(rotation))
                .add("add", new ModelText()
                        ...
                        .background(Color.fromARGB(0, 0, 0, 0))
                        .size(size)
                        .location(new Vector(0.60, 0, 0.15).rotateAroundY(rotation.y).toVector3f())
                        .rotation(rotation))
