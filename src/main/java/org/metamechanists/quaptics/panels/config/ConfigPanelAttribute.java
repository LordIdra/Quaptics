...
public class ConfigPanelAttribute {
    ...
    public ConfigPanelAttribute(final @NotNull Location location, final Vector offset, final Vector3f rotation, final Vector3f displaySize) {
        this.keyId = new TextDisplayId(new TextDisplayBuilder(location.add(offset))
                ...
                .build().getUniqueId());
        this.valueId = new TextDisplayId(new TextDisplayBuilder(location.add(offset))
                .setTransformation(Transformations.unadjustedTranslateRotateScale(displaySize, rotation, valueTranslation))
                .setBrightness(15)
                .setBackgroundColor(Color.fromARGB(0, 0, 0, 0))
                .build().getUniqueId());
        this.addId = new TextDisplayId(new TextDisplayBuilder(location.add(offset))
                ...
                .setBackgroundColor(Color.fromARGB(0, 0, 0, 0))
                .build().getUniqueId());
        this.subId = new TextDisplayId(new TextDisplayBuilder(location.add(offset))
